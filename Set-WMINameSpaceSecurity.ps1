...
# EXAMPLE1 works as-is for the OCHIN Employee domain as of 5/14/2019 (D.Lum)
...
.DESCRIPTION
   A Script for modifying the current security descriptor of a WMI namespace. 
.EXAMPLE1 
   Set-WMINamespaceSecurity.ps1 -namespace root/cimv2 -account "communityhealth\svc.monitoring" -operation Add -permissions Enable,RemoteAccess
.EXAMPLE
